...
if answer == "left":
    ...
    answer = input("You came to bridge, it looks wobbly, do you want to cross it or head back (cross/back)? ")
    ...
    if answer == "back":
        ...
        if answer == 'yes':
            print("You ignore the stranger and they give you gold. You WIN!")
